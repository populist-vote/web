  ...
  return (
    <Layout>
      <div className={styles.mprHeader}>
        ...
        <h1 className={styles.subHeading}>Build Your 2022 MN Election Ballot</h1>
        ...
        <p>
          ...
          <Link
            ...
            rel="noreferrer"
          >
          Share them with us</Link>, and stay informed on the latest news about who is running and what Minnesotans are looking for in our daily{" "}
          <Link
