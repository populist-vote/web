...
export type RaceFieldsFragment = { __typename?: 'RaceResult', id: string, raceType: RaceType, title: string, party?: PoliticalParty | null, office: { __typename?: 'OfficeResult', id: string, name?: string | null, title: string, subtitle?: string | null, state?: State | null, county?: string | null, municipality?: string | null, district?: string | null, electionScope: ElectionScope, districtType?: District | null, politicalScope: PoliticalScope, incumbent?: { __typename?: 'PoliticianResult', id: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null } | null }, candidates: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null }>, results: { __typename?: 'RaceResultsResult', totalVotes?: number | null, votesByCandidate: Array<{ __typename?: 'RaceCandidateResult', candidateId: string, votes?: number | null, votePercentage?: number | null }>, winner?: { __typename?: 'PoliticianResult', id: string } | null } };
...
export type SponsoredBillsFragment = { __typename?: 'PoliticianResult', sponsoredBills: { __typename?: 'BillResultConnection', edges: Array<{ __typename?: 'BillResultEdge', node: { __typename?: 'BillResult', slug: string, billNumber: string, title: string, legislationStatus: LegislationStatus } }> } };
...
export type PoliticianBioQuery = { __typename?: 'Query', politicianBySlug: { __typename?: 'PoliticianResult', biography?: string | null, biographySource?: string | null } };
...
export type PoliticianCurrentOfficeQuery = { __typename?: 'Query', politicianBySlug: { __typename?: 'PoliticianResult', officeId?: string | null, currentOffice?: { __typename?: 'OfficeResult', title: string, subtitle?: string | null, state?: State | null, electionScope: ElectionScope, district?: string | null, districtType?: District | null, municipality?: string | null } | null } };
...
export type PoliticianElectionInfoQuery = { __typename?: 'Query', politicianBySlug: { __typename?: 'PoliticianResult', id: string, upcomingRace?: { __typename?: 'RaceResult', title: string, raceType: RaceType, state?: State | null, electionDate?: any | null, office: { __typename?: 'OfficeResult', title: string, subtitle?: string | null, name?: string | null, state?: State | null, county?: string | null, municipality?: string | null, district?: string | null, schoolDistrict?: string | null, districtType?: District | null, electionScope: ElectionScope }, candidates: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, thumbnailImageUrl?: string | null, party?: PoliticalParty | null }> } | null } };
...
export type PoliticianSponsoredBillsQuery = { __typename?: 'Query', politicianBySlug: { __typename?: 'PoliticianResult', sponsoredBills: { __typename?: 'BillResultConnection', edges: Array<{ __typename?: 'BillResultEdge', node: { __typename?: 'BillResult', slug: string, billNumber: string, title: string, legislationStatus: LegislationStatus } }> } } };
...
export const useInfiniteUserCountByStateQuery = <
    ...
    useInfiniteQuery<UserCountByStateQuery, TError, TData>(
      variables === undefined ? ['UserCountByState.infinite'] : ['UserCountByState.infinite', variables],
      (metaData) => fetcher<UserCountByStateQuery, UserCountByStateQueryVariables>(UserCountByStateDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfiniteUserCountByStateQuery.getKey = (variables?: UserCountByStateQueryVariables) => variables === undefined ? ['UserCountByState.infinite'] : ['UserCountByState.infinite', variables];
;
...
export const useInfiniteElectionsQuery = <
    ...
    useInfiniteQuery<ElectionsQuery, TError, TData>(
      variables === undefined ? ['Elections.infinite'] : ['Elections.infinite', variables],
      (metaData) => fetcher<ElectionsQuery, ElectionsQueryVariables>(ElectionsDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfiniteElectionsQuery.getKey = (variables?: ElectionsQueryVariables) => variables === undefined ? ['Elections.infinite'] : ['Elections.infinite', variables];
;
...
export const useInfiniteElectionByIdQuery = <
    ...
    useInfiniteQuery<ElectionByIdQuery, TError, TData>(
      ...
      (metaData) => fetcher<ElectionByIdQuery, ElectionByIdQueryVariables>(ElectionByIdDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfiniteElectionByIdQuery.getKey = (variables: ElectionByIdQueryVariables) => ['ElectionById.infinite', variables];
;
...
export const useInfiniteElectionVotingGuideRacesQuery = <
    ...
    >(
      ...
      variables: ElectionVotingGuideRacesQueryVariables,
      options?: UseInfiniteQueryOptions<ElectionVotingGuideRacesQuery, TError, TData>
    ) =>
    useInfiniteQuery<ElectionVotingGuideRacesQuery, TError, TData>(
      ['ElectionVotingGuideRaces.infinite', variables],
      (metaData) => fetcher<ElectionVotingGuideRacesQuery, ElectionVotingGuideRacesQueryVariables>(ElectionVotingGuideRacesDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfiniteElectionVotingGuideRacesQuery.getKey = (variables: ElectionVotingGuideRacesQueryVariables) => ['ElectionVotingGuideRaces.infinite', variables];
;
...
export const useInfiniteMprFeaturedRacesQuery = <
    ...
    useInfiniteQuery<MprFeaturedRacesQuery, TError, TData>(
      variables === undefined ? ['MPRFeaturedRaces.infinite'] : ['MPRFeaturedRaces.infinite', variables],
      (metaData) => fetcher<MprFeaturedRacesQuery, MprFeaturedRacesQueryVariables>(MprFeaturedRacesDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfiniteMprFeaturedRacesQuery.getKey = (variables?: MprFeaturedRacesQueryVariables) => variables === undefined ? ['MPRFeaturedRaces.infinite'] : ['MPRFeaturedRaces.infinite', variables];
;
...
export const useInfiniteElectionBySlugQuery = <
    ...
    useInfiniteQuery<ElectionBySlugQuery, TError, TData>(
      ...
      (metaData) => fetcher<ElectionBySlugQuery, ElectionBySlugQueryVariables>(ElectionBySlugDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfiniteElectionBySlugQuery.getKey = (variables: ElectionBySlugQueryVariables) => ['ElectionBySlug.infinite', variables];
;
...
export const useInfiniteOrganizationPoliticianNotesQuery = <
    ...
    >(
      ...
      variables: OrganizationPoliticianNotesQueryVariables,
      options?: UseInfiniteQueryOptions<OrganizationPoliticianNotesQuery, TError, TData>
    ) =>
    useInfiniteQuery<OrganizationPoliticianNotesQuery, TError, TData>(
      ['OrganizationPoliticianNotes.infinite', variables],
      (metaData) => fetcher<OrganizationPoliticianNotesQuery, OrganizationPoliticianNotesQueryVariables>(OrganizationPoliticianNotesDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfiniteOrganizationPoliticianNotesQuery.getKey = (variables: OrganizationPoliticianNotesQueryVariables) => ['OrganizationPoliticianNotes.infinite', variables];
;
...
export const useInfinitePoliticianBasicInfoQuery = <
    ...
    useInfiniteQuery<PoliticianBasicInfoQuery, TError, TData>(
      ...
      (metaData) => fetcher<PoliticianBasicInfoQuery, PoliticianBasicInfoQueryVariables>(PoliticianBasicInfoDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfinitePoliticianBasicInfoQuery.getKey = (variables: PoliticianBasicInfoQueryVariables) => ['PoliticianBasicInfo.infinite', variables];
;
...
export const useInfinitePoliticianBioQuery = <
    ...
    useInfiniteQuery<PoliticianBioQuery, TError, TData>(
      ...
      (metaData) => fetcher<PoliticianBioQuery, PoliticianBioQueryVariables>(PoliticianBioDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfinitePoliticianBioQuery.getKey = (variables: PoliticianBioQueryVariables) => ['PoliticianBio.infinite', variables];
;
...
export const useInfinitePoliticianCurrentOfficeQuery = <
    ...
    useInfiniteQuery<PoliticianCurrentOfficeQuery, TError, TData>(
      ...
      (metaData) => fetcher<PoliticianCurrentOfficeQuery, PoliticianCurrentOfficeQueryVariables>(PoliticianCurrentOfficeDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfinitePoliticianCurrentOfficeQuery.getKey = (variables: PoliticianCurrentOfficeQueryVariables) => ['PoliticianCurrentOffice.infinite', variables];
;
...
export const useInfinitePoliticianElectionInfoQuery = <
    ...
    useInfiniteQuery<PoliticianElectionInfoQuery, TError, TData>(
      ...
      (metaData) => fetcher<PoliticianElectionInfoQuery, PoliticianElectionInfoQueryVariables>(PoliticianElectionInfoDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfinitePoliticianElectionInfoQuery.getKey = (variables: PoliticianElectionInfoQueryVariables) => ['PoliticianElectionInfo.infinite', variables];
;
...
export const useInfinitePoliticianEndorsementsQuery = <
    ...
    useInfiniteQuery<PoliticianEndorsementsQuery, TError, TData>(
      ...
      (metaData) => fetcher<PoliticianEndorsementsQuery, PoliticianEndorsementsQueryVariables>(PoliticianEndorsementsDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfinitePoliticianEndorsementsQuery.getKey = (variables: PoliticianEndorsementsQueryVariables) => ['PoliticianEndorsements.infinite', variables];
;
...
export const useInfinitePoliticianSponsoredBillsQuery = <
    ...
    >(
      ...
      variables: PoliticianSponsoredBillsQueryVariables,
      options?: UseInfiniteQueryOptions<PoliticianSponsoredBillsQuery, TError, TData>
    ) =>
    useInfiniteQuery<PoliticianSponsoredBillsQuery, TError, TData>(
      ['PoliticianSponsoredBills.infinite', variables],
      (metaData) => fetcher<PoliticianSponsoredBillsQuery, PoliticianSponsoredBillsQueryVariables>(PoliticianSponsoredBillsDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfinitePoliticianSponsoredBillsQuery.getKey = (variables: PoliticianSponsoredBillsQueryVariables) => ['PoliticianSponsoredBills.infinite', variables];
;
...
export const useInfinitePoliticianRatingsQuery = <
    ...
    useInfiniteQuery<PoliticianRatingsQuery, TError, TData>(
      ...
      (metaData) => fetcher<PoliticianRatingsQuery, PoliticianRatingsQueryVariables>(PoliticianRatingsDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfinitePoliticianRatingsQuery.getKey = (variables: PoliticianRatingsQueryVariables) => ['PoliticianRatings.infinite', variables];
;
...
export const useInfinitePoliticianFinancialsQuery = <
    ...
    useInfiniteQuery<PoliticianFinancialsQuery, TError, TData>(
      ...
      (metaData) => fetcher<PoliticianFinancialsQuery, PoliticianFinancialsQueryVariables>(PoliticianFinancialsDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );


useInfinitePoliticianFinancialsQuery.getKey = (variables: PoliticianFinancialsQueryVariables) => ['PoliticianFinancials.infinite', variables];
;
...
export const useInfiniteElectionVotingGuideByUserIdQuery = <
    ...
    >(
      ...
      variables: ElectionVotingGuideByUserIdQueryVariables,
      options?: UseInfiniteQueryOptions<ElectionVotingGuideByUserIdQuery, TError, TData>
    ) =>
