...
export type BillBySlugQuery = {
  ...
  billBySlug?: {
    ...
    legiscanCommitteeName?: string | null;
    usersVote?: ArgumentPosition | null;
    issueTags: Array<{
      __typename?: "IssueTagResult";
      id: string;
      name: string;
...
export type UpsertBillPublicVoteMutation = {
  __typename?: "Mutation";
...
export type BillIssueTagsQuery = {
  __typename?: "Query";
  billIssueTags: Array<{
    __typename?: "IssueTagResult";
    id: string;
...
export type BillCommitteesQuery = {
  __typename?: "Query";
  billCommittees: Array<{
    __typename?: "CommitteeResult";
    id: string;
    slug: string;
    name: string;
...
export const useBillIndexQuery = <TData = BillIndexQuery, TError = unknown>(
  ...
  useQuery<BillIndexQuery, TError, TData>(
    ...
    fetcher<BillIndexQuery, BillIndexQueryVariables>(
      BillIndexDocument,
      variables
    ),
    options
...
useBillIndexQuery.getKey = (variables?: BillIndexQueryVariables) =>
  variables === undefined ? ["BillIndex"] : ["BillIndex", variables];
useBillIndexQuery.fetcher = (variables?: BillIndexQueryVariables) =>
  fetcher<BillIndexQuery, BillIndexQueryVariables>(
    BillIndexDocument,
    variables
  );
...
>(
  ...
  useQuery<PopularBillsQuery, TError, TData>(
    ...
    fetcher<PopularBillsQuery, PopularBillsQueryVariables>(
      PopularBillsDocument,
      variables
    ),
    options
  );
...
usePopularBillsQuery.getKey = (variables?: PopularBillsQueryVariables) =>
  variables === undefined ? ["PopularBills"] : ["PopularBills", variables];
usePopularBillsQuery.fetcher = (variables?: PopularBillsQueryVariables) =>
  fetcher<PopularBillsQuery, PopularBillsQueryVariables>(
    PopularBillsDocument,
    variables
  );
...
>(
  options?: UseMutationOptions<
    UpsertBillPublicVoteMutation,
    TError,
    UpsertBillPublicVoteMutationVariables,
    TContext
  >
) =>
  useMutation<
  ...
  >(
    ["UpsertBillPublicVote"],
    (variables?: UpsertBillPublicVoteMutationVariables) =>
      fetcher<
        UpsertBillPublicVoteMutation,
        UpsertBillPublicVoteMutationVariables
      >(UpsertBillPublicVoteDocument, variables)(),
    options
  );
useUpsertBillPublicVoteMutation.fetcher = (
  variables: UpsertBillPublicVoteMutationVariables
) =>
  fetcher<UpsertBillPublicVoteMutation, UpsertBillPublicVoteMutationVariables>(
    UpsertBillPublicVoteDocument,
    variables
  );
...
>(
  ...
  useQuery<BillIssueTagsQuery, TError, TData>(
    ...
    fetcher<BillIssueTagsQuery, BillIssueTagsQueryVariables>(
      BillIssueTagsDocument,
      variables
    ),
    options
  );
...
useBillIssueTagsQuery.getKey = (variables?: BillIssueTagsQueryVariables) =>
  variables === undefined ? ["BillIssueTags"] : ["BillIssueTags", variables];
useBillIssueTagsQuery.fetcher = (variables?: BillIssueTagsQueryVariables) =>
  fetcher<BillIssueTagsQuery, BillIssueTagsQueryVariables>(
    BillIssueTagsDocument,
    variables
  );
...
>(
  ...
  useQuery<BillCommitteesQuery, TError, TData>(
    variables === undefined
      ? ["BillCommittees"]
      : ["BillCommittees", variables],
    fetcher<BillCommitteesQuery, BillCommitteesQueryVariables>(
      BillCommitteesDocument,
      variables
    ),
    options
  );
...
useBillCommitteesQuery.getKey = (variables?: BillCommitteesQueryVariables) =>
  variables === undefined ? ["BillCommittees"] : ["BillCommittees", variables];
useBillCommitteesQuery.fetcher = (variables?: BillCommitteesQueryVariables) =>
  fetcher<BillCommitteesQuery, BillCommitteesQueryVariables>(
    BillCommitteesDocument,
    variables
  );
