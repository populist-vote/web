...
export type VotingGuidesByUserIdQuery = { __typename?: 'Query', votingGuidesByUserId: Array<{ __typename?: 'VotingGuideResult', id: string, title?: string | null, description?: string | null, electionId: string, user: { __typename?: 'UserResult', id: string, username: string, lastName?: string | null, firstName?: string | null }, election: { __typename?: 'ElectionResult', slug: string, electionDate: any, title: string, description?: string | null } }> };
