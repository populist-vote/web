...
export type BallotMeasureSearch = {
  ...
  status?: InputMaybe<BallotMeasureStatus>;
  title?: InputMaybe<Scalars['String']>;
};

export enum BallotMeasureStatus {
  BecameLaw = 'BECAME_LAW',
  Failed = 'FAILED',
  GatheringSignatures = 'GATHERING_SIGNATURES',
  Introduced = 'INTRODUCED',
  InConsideration = 'IN_CONSIDERATION',
  OnTheBallot = 'ON_THE_BALLOT',
  Proposed = 'PROPOSED',
  Unknown = 'UNKNOWN'
}
...
export type BillResult = {
  ...
  legiscanCommitteeName?: Maybe<Scalars['String']>;
  legiscanData: Bill;
  officialSummary?: Maybe<Scalars['String']>;
  politicalScope: PoliticalScope;
  populistSummary?: Maybe<Scalars['String']>;
  publicVotes: PublicVotes;
  session?: Maybe<SessionResult>;
  sessionId?: Maybe<Scalars['ID']>;
  slug: Scalars['String'];
  sponsors: Array<PoliticianResult>;
  state?: Maybe<State>;
  status: BillStatus;
  title: Scalars['String'];
  usersVote?: Maybe<ArgumentPosition>;
  votesmartBillId?: Maybe<Scalars['Int']>;
};
...
export type BillSort = {
  popularity?: InputMaybe<PopularitySort>;
};
...
export enum BillType {
  ...
  Bill = 'BILL',
  /** DC City Council */
  CeremonialResolution = 'CEREMONIAL_RESOLUTION',
  ConcurrentMemorial = 'CONCURRENT_MEMORIAL',
  ConcurrentResolution = 'CONCURRENT_RESOLUTION',
  ConcurrentStudyRequest = 'CONCURRENT_STUDY_REQUEST',
  ConstitutionalAmendment = 'CONSTITUTIONAL_AMENDMENT',
  ExecutiveOrder = 'EXECUTIVE_ORDER',
  JointMemorial = 'JOINT_MEMORIAL',
  /** Some states have these types */
  JointResolution = 'JOINT_RESOLUTION',
  JointSessionResolution = 'JOINT_SESSION_RESOLUTION',
  Memorial = 'MEMORIAL',
  None = 'NONE',
  Proclamation = 'PROCLAMATION',
  Remonstration = 'REMONSTRATION',
  RepealBill = 'REPEAL_BILL',
...
export type CommitteeResult = {
  __typename?: 'CommitteeResult';
  chairId?: Maybe<Scalars['ID']>;
  description: Scalars['String'];
  id: Scalars['ID'];
  legiscanCommitteeId?: Maybe<Scalars['Int']>;
  name: Scalars['String'];
  slug: Scalars['String'];
  state?: Maybe<State>;
};
...
export type Mutation = {
  ...
  upsertBallotMeasure: BallotMeasureResult;
  upsertBill: BillResult;
  upsertBillPublicVote: PublicVotes;
...
export type MutationUpsertBallotMeasureArgs = {
  electionId: Scalars['UUID'];
  input: UpsertBallotMeasureInput;
};


export type MutationUpsertBillArgs = {
  input: UpsertBillInput;
};


export type MutationUpsertBillPublicVoteArgs = {
  billId: Scalars['ID'];
  position: ArgumentPosition;
  userId: Scalars['ID'];
};
...
export type PublicVotes = {
  __typename?: 'PublicVotes';
  neutral?: Maybe<Scalars['Int']>;
  oppose?: Maybe<Scalars['Int']>;
...
export type Query = {
  ...
  popularBills: BillResultConnection;
  raceById: RaceResult;
...
export type QueryPopularBillsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  filter?: InputMaybe<BillFilter>;
  first?: InputMaybe<Scalars['Int']>;
...
export type UpsertBallotMeasureInput = {
...
export type UpsertBillInput = {
  ...
  legiscanCommittee?: InputMaybe<Scalars['String']>;
  legiscanCommitteeId?: InputMaybe<Scalars['Int']>;
  legiscanData?: InputMaybe<Scalars['JSON']>;
  legiscanLastAction?: InputMaybe<Scalars['String']>;
  legiscanLastActionDate?: InputMaybe<Scalars['NaiveDate']>;
  legiscanSessionId?: InputMaybe<Scalars['Int']>;
  officialSummary?: InputMaybe<Scalars['String']>;
  politicalScope?: InputMaybe<PoliticalScope>;
  populistSummary?: InputMaybe<Scalars['String']>;
...
export type CurrentUserQuery = { __typename?: 'Query', currentUser?: { __typename?: 'AuthTokenResult', id: string, email: string, username: string, role: Role, userProfile: { __typename?: 'UserResult', profilePictureUrl?: string | null, firstName?: string | null, lastName?: string | null, address?: { __typename?: 'AddressResult', city: string, country: string, line1: string, line2?: string | null, postalCode: string, state: State } | null } } | null };
...
export type DeleteAccountByEmailMutation = { __typename?: 'Mutation', deleteAccountByEmail: string };
...
export type UserProfileQuery = { __typename?: 'Query', userProfile: { __typename?: 'UserResult', id: string, email: string, username: string, firstName?: string | null, lastName?: string | null, profilePictureUrl?: string | null, address?: { __typename?: 'AddressResult', city: string, country: string, line1: string, line2?: string | null, postalCode: string, state: State } | null } };
...
export type UpsertVotingGuideMutation = { __typename?: 'Mutation', upsertVotingGuide: { __typename?: 'VotingGuideResult', id: string, electionId: string, title?: string | null, description?: string | null } };
...
export type UpsertVotingGuideCandidateMutation = { __typename?: 'Mutation', upsertVotingGuideCandidate: { __typename?: 'VotingGuideCandidateResult', note?: string | null, isEndorsement: boolean } };
...
export type DeleteVotingGuideCandidateNoteMutation = { __typename?: 'Mutation', deleteVotingGuideCandidateNote: { __typename?: 'VotingGuideCandidateResult', isEndorsement: boolean, note?: string | null } };
...
export type UserCountByStateQuery = { __typename?: 'Query', userCount?: number | null };

export type RaceFieldsFragment = { __typename?: 'RaceResult', id: string, raceType: RaceType, title: string, party?: PoliticalParty | null, office: { __typename?: 'OfficeResult', id: string, name?: string | null, title: string, subtitle?: string | null, state?: State | null, county?: string | null, municipality?: string | null, district?: string | null, electionScope: ElectionScope, districtType?: District | null, politicalScope: PoliticalScope, incumbent?: { __typename?: 'PoliticianResult', id: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null } | null }, candidates: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null }>, results: { __typename?: 'RaceResultsResult', totalVotes?: number | null, votesByCandidate: Array<{ __typename?: 'RaceCandidateResult', candidateId: string, votes?: number | null, votePercentage?: number | null }>, winners?: Array<{ __typename?: 'PoliticianResult', id: string }> | null } };

export type ElectionFieldsFragment = { __typename?: 'ElectionResult', id: string, title: string, description?: string | null, electionDate: any };

export type ElectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type ElectionsQuery = { __typename?: 'Query', electionsByUserState: Array<{ __typename?: 'ElectionResult', id: string, electionDate: any }> };
...
export type ElectionByIdQuery = { __typename?: 'Query', electionById: { __typename?: 'ElectionResult', id: string, title: string, description?: string | null, electionDate: any, racesByUserDistricts: Array<{ __typename?: 'RaceResult', id: string, raceType: RaceType, title: string, party?: PoliticalParty | null, office: { __typename?: 'OfficeResult', id: string, name?: string | null, title: string, subtitle?: string | null, state?: State | null, county?: string | null, municipality?: string | null, district?: string | null, electionScope: ElectionScope, districtType?: District | null, politicalScope: PoliticalScope, incumbent?: { __typename?: 'PoliticianResult', id: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null } | null }, candidates: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null }>, results: { __typename?: 'RaceResultsResult', totalVotes?: number | null, votesByCandidate: Array<{ __typename?: 'RaceCandidateResult', candidateId: string, votes?: number | null, votePercentage?: number | null }>, winners?: Array<{ __typename?: 'PoliticianResult', id: string }> | null } }> } };
...
export type ElectionVotingGuideRacesQuery = { __typename?: 'Query', electionById: { __typename?: 'ElectionResult', id: string, title: string, description?: string | null, electionDate: any, racesByVotingGuide: Array<{ __typename?: 'RaceResult', id: string, raceType: RaceType, title: string, party?: PoliticalParty | null, office: { __typename?: 'OfficeResult', id: string, name?: string | null, title: string, subtitle?: string | null, state?: State | null, county?: string | null, municipality?: string | null, district?: string | null, electionScope: ElectionScope, districtType?: District | null, politicalScope: PoliticalScope, incumbent?: { __typename?: 'PoliticianResult', id: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null } | null }, candidates: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null }>, results: { __typename?: 'RaceResultsResult', totalVotes?: number | null, votesByCandidate: Array<{ __typename?: 'RaceCandidateResult', candidateId: string, votes?: number | null, votePercentage?: number | null }>, winners?: Array<{ __typename?: 'PoliticianResult', id: string }> | null } }> } };

export type BillIndexQueryVariables = Exact<{
...
export type BillIndexQuery = { __typename?: 'Query', bills: { __typename?: 'BillResultConnection', totalCount: number, edges: Array<{ __typename?: 'BillResultEdge', node: { __typename?: 'BillResult', id: string, slug: string, title: string, status: BillStatus, state?: State | null, billNumber: string, issueTags: Array<{ __typename?: 'IssueTagResult', id: string, slug: string, name: string }>, publicVotes: { __typename?: 'PublicVotes', support?: number | null, oppose?: number | null }, session?: { __typename?: 'SessionResult', name: string, startDate?: any | null, endDate?: any | null } | null } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null } } };

export type PopularBillsQueryVariables = Exact<{
  pageSize?: InputMaybe<Scalars['Int']>;
  cursor?: InputMaybe<Scalars['String']>;
  filter?: InputMaybe<BillFilter>;
}>;
...
export type PopularBillsQuery = { __typename?: 'Query', popularBills: { __typename?: 'BillResultConnection', totalCount: number, edges: Array<{ __typename?: 'BillResultEdge', node: { __typename?: 'BillResult', id: string, slug: string, title: string, status: BillStatus, state?: State | null, billNumber: string, issueTags: Array<{ __typename?: 'IssueTagResult', id: string, slug: string, name: string }>, publicVotes: { __typename?: 'PublicVotes', support?: number | null, oppose?: number | null }, session?: { __typename?: 'SessionResult', name: string, startDate?: any | null, endDate?: any | null } | null } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null } } };
...
export type BillBySlugQuery = { __typename?: 'Query', billBySlug?: { __typename?: 'BillResult', id: string, slug: string, title: string, description?: string | null, billNumber: string, status: BillStatus, state?: State | null, officialSummary?: string | null, populistSummary?: string | null, fullTextUrl?: string | null, legiscanCommitteeName?: string | null, usersVote?: ArgumentPosition | null, issueTags: Array<{ __typename?: 'IssueTagResult', id: string, name: string, slug: string }>, sponsors: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null, fullName: string, currentOffice?: { __typename?: 'OfficeResult', id: string, officeType?: string | null, state?: State | null, district?: string | null } | null }>, session?: { __typename?: 'SessionResult', name: string, startDate?: any | null, endDate?: any | null } | null, publicVotes: { __typename?: 'PublicVotes', support?: number | null, neutral?: number | null, oppose?: number | null } } | null };

export type UpsertBillPublicVoteMutationVariables = Exact<{
  billId: Scalars['ID'];
  userId: Scalars['ID'];
  position: ArgumentPosition;
}>;
...
export type UpsertBillPublicVoteMutation = { __typename?: 'Mutation', upsertBillPublicVote: { __typename?: 'PublicVotes', support?: number | null, neutral?: number | null, oppose?: number | null } };

export type BillFieldsFragment = { __typename?: 'BillResult', id: string, slug: string, title: string, status: BillStatus, state?: State | null, billNumber: string, issueTags: Array<{ __typename?: 'IssueTagResult', id: string, slug: string, name: string }>, publicVotes: { __typename?: 'PublicVotes', support?: number | null, oppose?: number | null }, session?: { __typename?: 'SessionResult', name: string, startDate?: any | null, endDate?: any | null } | null };

export type BillIssueTagsQueryVariables = Exact<{ [key: string]: never; }>;


export type BillIssueTagsQuery = { __typename?: 'Query', billIssueTags: Array<{ __typename?: 'IssueTagResult', id: string, name: string, description?: string | null, slug: string }> };

export type BillCommitteesQueryVariables = Exact<{ [key: string]: never; }>;


export type BillCommitteesQuery = { __typename?: 'Query', billCommittees: Array<{ __typename?: 'CommitteeResult', id: string, slug: string, name: string }> };

export type MprFeaturedRacesQueryVariables = Exact<{ [key: string]: never; }>;


export type MprFeaturedRacesQuery = { __typename?: 'Query', races: Array<{ __typename?: 'RaceResult', id: string, raceType: RaceType, title: string, party?: PoliticalParty | null, office: { __typename?: 'OfficeResult', id: string, name?: string | null, title: string, subtitle?: string | null, state?: State | null, county?: string | null, municipality?: string | null, district?: string | null, electionScope: ElectionScope, districtType?: District | null, politicalScope: PoliticalScope, incumbent?: { __typename?: 'PoliticianResult', id: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null } | null }, candidates: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, party?: PoliticalParty | null, thumbnailImageUrl?: string | null }>, results: { __typename?: 'RaceResultsResult', totalVotes?: number | null, votesByCandidate: Array<{ __typename?: 'RaceCandidateResult', candidateId: string, votes?: number | null, votePercentage?: number | null }>, winners?: Array<{ __typename?: 'PoliticianResult', id: string }> | null } }> };
...
export type ElectionBySlugQuery = { __typename?: 'Query', electionBySlug: { __typename?: 'ElectionResult', id: string, slug: string, description?: string | null } };

export type OrganizationFieldsFragment = { __typename?: 'OrganizationResult', id: string, name: string, slug: string, description?: string | null, thumbnailImageUrl?: string | null, websiteUrl?: string | null, twitterUrl?: string | null, facebookUrl?: string | null, instagramUrl?: string | null, assets: { __typename?: 'OrganizationAssets', thumbnailImage160?: string | null, thumbnailImage400?: string | null }, issueTags: Array<{ __typename?: 'IssueTagResult', id: string, name: string, slug: string, description?: string | null }> };
...
export type OrganizationBySlugQuery = { __typename?: 'Query', organizationBySlug: { __typename?: 'OrganizationResult', id: string, name: string, slug: string, description?: string | null, thumbnailImageUrl?: string | null, websiteUrl?: string | null, twitterUrl?: string | null, facebookUrl?: string | null, instagramUrl?: string | null, assets: { __typename?: 'OrganizationAssets', thumbnailImage160?: string | null, thumbnailImage400?: string | null }, issueTags: Array<{ __typename?: 'IssueTagResult', id: string, name: string, slug: string, description?: string | null }> } };
...
export type OrganizationPoliticianNotesQuery = { __typename?: 'Query', organizationBySlug: { __typename?: 'OrganizationResult', politicianNotes: Array<{ __typename?: 'OrganizationPoliticianNoteResult', id: string, notes: any, politician: { __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, party?: PoliticalParty | null, assets: { __typename?: 'PoliticianAssets', thumbnailImage160?: string | null, thumbnailImage400?: string | null }, upcomingRace?: { __typename?: 'RaceResult', office: { __typename?: 'OfficeResult', slug: string, name?: string | null, title: string, subtitleShort?: string | null, priority?: number | null, incumbent?: { __typename?: 'PoliticianResult', id: string } | null } } | null }, issueTags: Array<{ __typename?: 'IssueTagResult', name: string, slug: string, id: string }> }> } };
...
export type PoliticianIndexQuery = { __typename?: 'Query', politicians: { __typename?: 'PoliticianResultConnection', totalCount: number, edges: Array<{ __typename?: 'PoliticianResultEdge', node: { __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, homeState?: State | null, party?: PoliticalParty | null, thumbnailImageUrl?: string | null, currentOffice?: { __typename?: 'OfficeResult', id: string, slug: string, title: string, subtitle?: string | null, subtitleShort?: string | null, municipality?: string | null, district?: string | null, state?: State | null, officeType?: string | null } | null } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null } } };

export type BasicInfoFragment = { __typename?: 'PoliticianResult', id: string, fullName: string, preferredName?: string | null, homeState?: State | null, party?: PoliticalParty | null, yearsInPublicOffice?: number | null, raceWins?: number | null, raceLosses?: number | null, age?: number | null, officialWebsiteUrl?: string | null, campaignWebsiteUrl?: string | null, twitterUrl?: string | null, facebookUrl?: string | null, instagramUrl?: string | null, tiktokUrl?: string | null, youtubeUrl?: string | null, linkedinUrl?: string | null, thumbnailImageUrl?: string | null, votesmartCandidateBio?: { __typename?: 'GetCandidateBioResponse', office?: { __typename?: 'Office', name: Array<string>, termStart: string, termEnd: string } | null, candidate: { __typename?: 'Candidate', photo: string, congMembership: any } } | null, assets: { __typename?: 'PoliticianAssets', thumbnailImage400?: string | null } };

export type BioFragment = { __typename?: 'PoliticianResult', biography?: string | null, biographySource?: string | null };

export type CurrentOfficeFragment = { __typename?: 'PoliticianResult', officeId?: string | null, currentOffice?: { __typename?: 'OfficeResult', title: string, subtitle?: string | null, state?: State | null, electionScope: ElectionScope, district?: string | null, districtType?: District | null, municipality?: string | null } | null };

export type ElectionInfoFragment = { __typename?: 'PoliticianResult', id: string, upcomingRace?: { __typename?: 'RaceResult', title: string, raceType: RaceType, state?: State | null, electionDate?: any | null, office: { __typename?: 'OfficeResult', title: string, subtitle?: string | null, name?: string | null, state?: State | null, county?: string | null, municipality?: string | null, district?: string | null, schoolDistrict?: string | null, districtType?: District | null, electionScope: ElectionScope }, candidates: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, thumbnailImageUrl?: string | null, party?: PoliticalParty | null }> } | null };

export type EndorsementsFragment = { __typename?: 'PoliticianResult', endorsements: { __typename?: 'Endorsements', organizations: Array<{ __typename?: 'OrganizationResult', id: string, slug: string, name: string, thumbnailImageUrl?: string | null, assets: { __typename?: 'OrganizationAssets', thumbnailImage160?: string | null } }>, politicians: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, homeState?: State | null, party?: PoliticalParty | null, thumbnailImageUrl?: string | null, currentOffice?: { __typename?: 'OfficeResult', id: string, slug: string, title: string, municipality?: string | null, district?: string | null, state?: State | null, officeType?: string | null } | null, votesmartCandidateBio?: { __typename?: 'GetCandidateBioResponse', office?: { __typename?: 'Office', name: Array<string>, district: string, typeField: string } | null, candidate: { __typename?: 'Candidate', photo: string } } | null }> } };

export type SponsoredBillsFragment = { __typename?: 'PoliticianResult', sponsoredBills: { __typename?: 'BillResultConnection', edges: Array<{ __typename?: 'BillResultEdge', node: { __typename?: 'BillResult', slug: string, billNumber: string, title: string, status: BillStatus, session?: { __typename?: 'SessionResult', startDate?: any | null, endDate?: any | null } | null } }> } };

export type RatingsFragment = { __typename?: 'PoliticianResult', ratings: { __typename?: 'RatingResultConnection', edges: Array<{ __typename?: 'RatingResultEdge', node: { __typename?: 'RatingResult', vsRating: { __typename?: 'VsRating', rating: any, timespan: any }, organization?: { __typename?: 'OrganizationResult', slug: string, name: string, thumbnailImageUrl?: string | null, assets: { __typename?: 'OrganizationAssets', thumbnailImage160?: string | null } } | null } }> } };

export type FinancialsFragment = { __typename?: 'PoliticianResult', donationsByIndustry?: { __typename?: 'DonationsByIndustry', cycle: number, lastUpdated: any, source: string, sectors: Array<{ __typename?: 'Sector', name: string, id: string, individuals: number, pacs: number, total: number }> } | null, donationsSummary?: { __typename?: 'DonationsSummary', totalRaised: number, spent: number, cashOnHand: number, debt: number, source: string, lastUpdated: any } | null };
...
export type PoliticianBasicInfoQuery = { __typename?: 'Query', politicianBySlug?: { __typename?: 'PoliticianResult', id: string, fullName: string, preferredName?: string | null, homeState?: State | null, party?: PoliticalParty | null, yearsInPublicOffice?: number | null, raceWins?: number | null, raceLosses?: number | null, age?: number | null, officialWebsiteUrl?: string | null, campaignWebsiteUrl?: string | null, twitterUrl?: string | null, facebookUrl?: string | null, instagramUrl?: string | null, tiktokUrl?: string | null, youtubeUrl?: string | null, linkedinUrl?: string | null, thumbnailImageUrl?: string | null, votesmartCandidateBio?: { __typename?: 'GetCandidateBioResponse', office?: { __typename?: 'Office', name: Array<string>, termStart: string, termEnd: string } | null, candidate: { __typename?: 'Candidate', photo: string, congMembership: any } } | null, assets: { __typename?: 'PoliticianAssets', thumbnailImage400?: string | null } } | null };
...
export type PoliticianBioQuery = { __typename?: 'Query', politicianBySlug?: { __typename?: 'PoliticianResult', biography?: string | null, biographySource?: string | null } | null };
...
export type PoliticianCurrentOfficeQuery = { __typename?: 'Query', politicianBySlug?: { __typename?: 'PoliticianResult', officeId?: string | null, currentOffice?: { __typename?: 'OfficeResult', title: string, subtitle?: string | null, state?: State | null, electionScope: ElectionScope, district?: string | null, districtType?: District | null, municipality?: string | null } | null } | null };
...
export type PoliticianElectionInfoQuery = { __typename?: 'Query', politicianBySlug?: { __typename?: 'PoliticianResult', id: string, upcomingRace?: { __typename?: 'RaceResult', title: string, raceType: RaceType, state?: State | null, electionDate?: any | null, office: { __typename?: 'OfficeResult', title: string, subtitle?: string | null, name?: string | null, state?: State | null, county?: string | null, municipality?: string | null, district?: string | null, schoolDistrict?: string | null, districtType?: District | null, electionScope: ElectionScope }, candidates: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, thumbnailImageUrl?: string | null, party?: PoliticalParty | null }> } | null } | null };
...
export type PoliticianEndorsementsQuery = { __typename?: 'Query', politicianBySlug?: { __typename?: 'PoliticianResult', endorsements: { __typename?: 'Endorsements', organizations: Array<{ __typename?: 'OrganizationResult', id: string, slug: string, name: string, thumbnailImageUrl?: string | null, assets: { __typename?: 'OrganizationAssets', thumbnailImage160?: string | null } }>, politicians: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, homeState?: State | null, party?: PoliticalParty | null, thumbnailImageUrl?: string | null, currentOffice?: { __typename?: 'OfficeResult', id: string, slug: string, title: string, municipality?: string | null, district?: string | null, state?: State | null, officeType?: string | null } | null, votesmartCandidateBio?: { __typename?: 'GetCandidateBioResponse', office?: { __typename?: 'Office', name: Array<string>, district: string, typeField: string } | null, candidate: { __typename?: 'Candidate', photo: string } } | null }> } } | null };
...
export type PoliticianSponsoredBillsQuery = { __typename?: 'Query', politicianBySlug?: { __typename?: 'PoliticianResult', sponsoredBills: { __typename?: 'BillResultConnection', edges: Array<{ __typename?: 'BillResultEdge', node: { __typename?: 'BillResult', slug: string, billNumber: string, title: string, status: BillStatus, session?: { __typename?: 'SessionResult', startDate?: any | null, endDate?: any | null } | null } }> } } | null };
...
export type PoliticianRatingsQuery = { __typename?: 'Query', politicianBySlug?: { __typename?: 'PoliticianResult', ratings: { __typename?: 'RatingResultConnection', edges: Array<{ __typename?: 'RatingResultEdge', node: { __typename?: 'RatingResult', vsRating: { __typename?: 'VsRating', rating: any, timespan: any }, organization?: { __typename?: 'OrganizationResult', slug: string, name: string, thumbnailImageUrl?: string | null, assets: { __typename?: 'OrganizationAssets', thumbnailImage160?: string | null } } | null } }> } } | null };
...
export type PoliticianFinancialsQuery = { __typename?: 'Query', politicianBySlug?: { __typename?: 'PoliticianResult', donationsByIndustry?: { __typename?: 'DonationsByIndustry', cycle: number, lastUpdated: any, source: string, sectors: Array<{ __typename?: 'Sector', name: string, id: string, individuals: number, pacs: number, total: number }> } | null, donationsSummary?: { __typename?: 'DonationsSummary', totalRaised: number, spent: number, cashOnHand: number, debt: number, source: string, lastUpdated: any } | null } | null };
...
export type PoliticianBySlugQuery = { __typename?: 'Query', politicianBySlug?: { __typename?: 'PoliticianResult', id: string, fullName: string, preferredName?: string | null, homeState?: State | null, party?: PoliticalParty | null, yearsInPublicOffice?: number | null, raceWins?: number | null, raceLosses?: number | null, age?: number | null, officialWebsiteUrl?: string | null, campaignWebsiteUrl?: string | null, twitterUrl?: string | null, facebookUrl?: string | null, instagramUrl?: string | null, tiktokUrl?: string | null, youtubeUrl?: string | null, linkedinUrl?: string | null, thumbnailImageUrl?: string | null, biography?: string | null, biographySource?: string | null, officeId?: string | null, votesmartCandidateBio?: { __typename?: 'GetCandidateBioResponse', office?: { __typename?: 'Office', name: Array<string>, termStart: string, termEnd: string } | null, candidate: { __typename?: 'Candidate', photo: string, congMembership: any } } | null, assets: { __typename?: 'PoliticianAssets', thumbnailImage400?: string | null }, currentOffice?: { __typename?: 'OfficeResult', title: string, subtitle?: string | null, state?: State | null, electionScope: ElectionScope, district?: string | null, districtType?: District | null, municipality?: string | null } | null, upcomingRace?: { __typename?: 'RaceResult', title: string, raceType: RaceType, state?: State | null, electionDate?: any | null, office: { __typename?: 'OfficeResult', title: string, subtitle?: string | null, name?: string | null, state?: State | null, county?: string | null, municipality?: string | null, district?: string | null, schoolDistrict?: string | null, districtType?: District | null, electionScope: ElectionScope }, candidates: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, thumbnailImageUrl?: string | null, party?: PoliticalParty | null }> } | null, endorsements: { __typename?: 'Endorsements', organizations: Array<{ __typename?: 'OrganizationResult', id: string, slug: string, name: string, thumbnailImageUrl?: string | null, assets: { __typename?: 'OrganizationAssets', thumbnailImage160?: string | null } }>, politicians: Array<{ __typename?: 'PoliticianResult', id: string, slug: string, fullName: string, homeState?: State | null, party?: PoliticalParty | null, thumbnailImageUrl?: string | null, currentOffice?: { __typename?: 'OfficeResult', id: string, slug: string, title: string, municipality?: string | null, district?: string | null, state?: State | null, officeType?: string | null } | null, votesmartCandidateBio?: { __typename?: 'GetCandidateBioResponse', office?: { __typename?: 'Office', name: Array<string>, district: string, typeField: string } | null, candidate: { __typename?: 'Candidate', photo: string } } | null }> }, sponsoredBills: { __typename?: 'BillResultConnection', edges: Array<{ __typename?: 'BillResultEdge', node: { __typename?: 'BillResult', slug: string, billNumber: string, title: string, status: BillStatus, session?: { __typename?: 'SessionResult', startDate?: any | null, endDate?: any | null } | null } }> }, ratings: { __typename?: 'RatingResultConnection', edges: Array<{ __typename?: 'RatingResultEdge', node: { __typename?: 'RatingResult', vsRating: { __typename?: 'VsRating', rating: any, timespan: any }, organization?: { __typename?: 'OrganizationResult', slug: string, name: string, thumbnailImageUrl?: string | null, assets: { __typename?: 'OrganizationAssets', thumbnailImage160?: string | null } } | null } }> } } | null };

export type GuideFieldsFragment = { __typename?: 'VotingGuideResult', id: string, title?: string | null, description?: string | null, electionId: string, user: { __typename?: 'UserResult', id: string, username: string, lastName?: string | null, firstName?: string | null, profilePictureUrl?: string | null }, election: { __typename?: 'ElectionResult', id: string, title: string, description?: string | null, electionDate: any }, candidates: Array<{ __typename?: 'VotingGuideCandidateResult', isEndorsement: boolean, note?: string | null, politician: { __typename?: 'PoliticianResult', id: string } }> };
...
export type VotingGuideByIdQuery = { __typename?: 'Query', votingGuideById: { __typename?: 'VotingGuideResult', id: string, title?: string | null, description?: string | null, electionId: string, user: { __typename?: 'UserResult', id: string, username: string, lastName?: string | null, firstName?: string | null, profilePictureUrl?: string | null }, election: { __typename?: 'ElectionResult', id: string, title: string, description?: string | null, electionDate: any }, candidates: Array<{ __typename?: 'VotingGuideCandidateResult', isEndorsement: boolean, note?: string | null, politician: { __typename?: 'PoliticianResult', id: string } }> } };
...
export type VotingGuidesByUserIdQuery = { __typename?: 'Query', votingGuidesByUserId: Array<{ __typename?: 'VotingGuideResult', id: string, title?: string | null, description?: string | null, electionId: string, user: { __typename?: 'UserResult', id: string, username: string, lastName?: string | null, firstName?: string | null, profilePictureUrl?: string | null }, election: { __typename?: 'ElectionResult', id: string, title: string, description?: string | null, electionDate: any }, candidates: Array<{ __typename?: 'VotingGuideCandidateResult', isEndorsement: boolean, note?: string | null, politician: { __typename?: 'PoliticianResult', id: string } }> }> };
...
export type ElectionVotingGuideByUserIdQuery = { __typename?: 'Query', electionVotingGuideByUserId?: { __typename?: 'VotingGuideResult', id: string } | null };
...
export type VotingGuidesByIdsQuery = { __typename?: 'Query', votingGuidesByIds: Array<{ __typename?: 'VotingGuideResult', id: string, title?: string | null, description?: string | null, electionId: string, user: { __typename?: 'UserResult', id: string, username: string, lastName?: string | null, firstName?: string | null, profilePictureUrl?: string | null }, election: { __typename?: 'ElectionResult', id: string, title: string, description?: string | null, electionDate: any }, candidates: Array<{ __typename?: 'VotingGuideCandidateResult', isEndorsement: boolean, note?: string | null, politician: { __typename?: 'PoliticianResult', id: string } }> }> };
...
export const RaceFieldsFragmentDoc = /*#__PURE__*/ `
  ...
  results {
    ...
    `;
export const BillFieldsFragmentDoc = /*#__PURE__*/ `
...
export const useDeleteAccountByEmailMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<DeleteAccountByEmailMutation, TError, DeleteAccountByEmailMutationVariables, TContext>) =>
    useMutation<DeleteAccountByEmailMutation, TError, DeleteAccountByEmailMutationVariables, TContext>(
      ['DeleteAccountByEmail'],
      (variables?: DeleteAccountByEmailMutationVariables) => fetcher<DeleteAccountByEmailMutation, DeleteAccountByEmailMutationVariables>(DeleteAccountByEmailDocument, variables)(),
      options
    );
useDeleteAccountByEmailMutation.fetcher = (variables: DeleteAccountByEmailMutationVariables) => fetcher<DeleteAccountByEmailMutation, DeleteAccountByEmailMutationVariables>(DeleteAccountByEmailDocument, variables);
...
export const useUploadProfilePictureMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<UploadProfilePictureMutation, TError, UploadProfilePictureMutationVariables, TContext>) =>
    useMutation<UploadProfilePictureMutation, TError, UploadProfilePictureMutationVariables, TContext>(
      ['UploadProfilePicture'],
      (variables?: UploadProfilePictureMutationVariables) => fetcher<UploadProfilePictureMutation, UploadProfilePictureMutationVariables>(UploadProfilePictureDocument, variables)(),
      options
    );
useUploadProfilePictureMutation.fetcher = (variables: UploadProfilePictureMutationVariables) => fetcher<UploadProfilePictureMutation, UploadProfilePictureMutationVariables>(UploadProfilePictureDocument, variables);
...
export const useDeleteProfilePictureMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<DeleteProfilePictureMutation, TError, DeleteProfilePictureMutationVariables, TContext>) =>
    useMutation<DeleteProfilePictureMutation, TError, DeleteProfilePictureMutationVariables, TContext>(
      ['DeleteProfilePicture'],
      (variables?: DeleteProfilePictureMutationVariables) => fetcher<DeleteProfilePictureMutation, DeleteProfilePictureMutationVariables>(DeleteProfilePictureDocument, variables)(),
      options
    );
useDeleteProfilePictureMutation.fetcher = (variables?: DeleteProfilePictureMutationVariables) => fetcher<DeleteProfilePictureMutation, DeleteProfilePictureMutationVariables>(DeleteProfilePictureDocument, variables);
...
export const useDeleteVotingGuideCandidateNoteMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<DeleteVotingGuideCandidateNoteMutation, TError, DeleteVotingGuideCandidateNoteMutationVariables, TContext>) =>
    useMutation<DeleteVotingGuideCandidateNoteMutation, TError, DeleteVotingGuideCandidateNoteMutationVariables, TContext>(
      ['DeleteVotingGuideCandidateNote'],
      (variables?: DeleteVotingGuideCandidateNoteMutationVariables) => fetcher<DeleteVotingGuideCandidateNoteMutation, DeleteVotingGuideCandidateNoteMutationVariables>(DeleteVotingGuideCandidateNoteDocument, variables)(),
      options
    );
useDeleteVotingGuideCandidateNoteMutation.fetcher = (variables: DeleteVotingGuideCandidateNoteMutationVariables) => fetcher<DeleteVotingGuideCandidateNoteMutation, DeleteVotingGuideCandidateNoteMutationVariables>(DeleteVotingGuideCandidateNoteDocument, variables);
...
export const useUserCountByStateQuery = <
    ...
    useQuery<UserCountByStateQuery, TError, TData>(
      variables === undefined ? ['UserCountByState'] : ['UserCountByState', variables],
      fetcher<UserCountByStateQuery, UserCountByStateQueryVariables>(UserCountByStateDocument, variables),
      options
    );
useUserCountByStateQuery.document = UserCountByStateDocument;


useUserCountByStateQuery.getKey = (variables?: UserCountByStateQueryVariables) => variables === undefined ? ['UserCountByState'] : ['UserCountByState', variables];
;

useUserCountByStateQuery.fetcher = (variables?: UserCountByStateQueryVariables) => fetcher<UserCountByStateQuery, UserCountByStateQueryVariables>(UserCountByStateDocument, variables);
export const ElectionsDocument = /*#__PURE__*/ `
  ...
  electionsByUserState {
    ...
    `;
export const useElectionsQuery = <
    ...
    useQuery<ElectionsQuery, TError, TData>(
      ...
      fetcher<ElectionsQuery, ElectionsQueryVariables>(ElectionsDocument, variables),
      options
    );
useElectionsQuery.document = ElectionsDocument;


useElectionsQuery.getKey = (variables?: ElectionsQueryVariables) => variables === undefined ? ['Elections'] : ['Elections', variables];
;

useElectionsQuery.fetcher = (variables?: ElectionsQueryVariables) => fetcher<ElectionsQuery, ElectionsQueryVariables>(ElectionsDocument, variables);
...
export const useElectionByIdQuery = <
    ...
    useQuery<ElectionByIdQuery, TError, TData>(
      ...
      fetcher<ElectionByIdQuery, ElectionByIdQueryVariables>(ElectionByIdDocument, variables),
      options
    );
useElectionByIdQuery.document = ElectionByIdDocument;


useElectionByIdQuery.getKey = (variables: ElectionByIdQueryVariables) => ['ElectionById', variables];
;

useElectionByIdQuery.fetcher = (variables: ElectionByIdQueryVariables) => fetcher<ElectionByIdQuery, ElectionByIdQueryVariables>(ElectionByIdDocument, variables);
...
export const useElectionVotingGuideRacesQuery = <
    ...
    useQuery<ElectionVotingGuideRacesQuery, TError, TData>(
      ...
      fetcher<ElectionVotingGuideRacesQuery, ElectionVotingGuideRacesQueryVariables>(ElectionVotingGuideRacesDocument, variables),
      options
    );
useElectionVotingGuideRacesQuery.document = ElectionVotingGuideRacesDocument;


useElectionVotingGuideRacesQuery.getKey = (variables: ElectionVotingGuideRacesQueryVariables) => ['ElectionVotingGuideRaces', variables];
;

useElectionVotingGuideRacesQuery.fetcher = (variables: ElectionVotingGuideRacesQueryVariables) => fetcher<ElectionVotingGuideRacesQuery, ElectionVotingGuideRacesQueryVariables>(ElectionVotingGuideRacesDocument, variables);
export const BillIndexDocument = /*#__PURE__*/ `
    query BillIndex($pageSize: Int, $cursor: String, $filter: BillFilter, $sort: BillSort) {
...
export const useBillIndexQuery = <
      TData = BillIndexQuery,
      TError = unknown
    >(
      variables?: BillIndexQueryVariables,
      options?: UseQueryOptions<BillIndexQuery, TError, TData>
    ) =>
    useQuery<BillIndexQuery, TError, TData>(
      variables === undefined ? ['BillIndex'] : ['BillIndex', variables],
      fetcher<BillIndexQuery, BillIndexQueryVariables>(BillIndexDocument, variables),
      options
    );
useBillIndexQuery.document = BillIndexDocument;


useBillIndexQuery.getKey = (variables?: BillIndexQueryVariables) => variables === undefined ? ['BillIndex'] : ['BillIndex', variables];
;

useBillIndexQuery.fetcher = (variables?: BillIndexQueryVariables) => fetcher<BillIndexQuery, BillIndexQueryVariables>(BillIndexDocument, variables);
export const PopularBillsDocument = /*#__PURE__*/ `
    query PopularBills($pageSize: Int, $cursor: String, $filter: BillFilter) {
  popularBills(first: $pageSize, after: $cursor, filter: $filter) {
    edges {
      node {
        ...BillFields
      }
    ...
    ${BillFieldsFragmentDoc}`;
export const usePopularBillsQuery = <
      TData = PopularBillsQuery,
      TError = unknown
    >(
      variables?: PopularBillsQueryVariables,
      options?: UseQueryOptions<PopularBillsQuery, TError, TData>
    ) =>
    useQuery<PopularBillsQuery, TError, TData>(
      variables === undefined ? ['PopularBills'] : ['PopularBills', variables],
      fetcher<PopularBillsQuery, PopularBillsQueryVariables>(PopularBillsDocument, variables),
      options
    );
usePopularBillsQuery.document = PopularBillsDocument;


usePopularBillsQuery.getKey = (variables?: PopularBillsQueryVariables) => variables === undefined ? ['PopularBills'] : ['PopularBills', variables];
;

usePopularBillsQuery.fetcher = (variables?: PopularBillsQueryVariables) => fetcher<PopularBillsQuery, PopularBillsQueryVariables>(PopularBillsDocument, variables);
...
export const UpsertBillPublicVoteDocument = /*#__PURE__*/ `
  ...
  upsertBillPublicVote(billId: $billId, userId: $userId, position: $position) {
    ...
    `;
export const useUpsertBillPublicVoteMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<UpsertBillPublicVoteMutation, TError, UpsertBillPublicVoteMutationVariables, TContext>) =>
    useMutation<UpsertBillPublicVoteMutation, TError, UpsertBillPublicVoteMutationVariables, TContext>(
      ['UpsertBillPublicVote'],
      (variables?: UpsertBillPublicVoteMutationVariables) => fetcher<UpsertBillPublicVoteMutation, UpsertBillPublicVoteMutationVariables>(UpsertBillPublicVoteDocument, variables)(),
      options
    );
useUpsertBillPublicVoteMutation.fetcher = (variables: UpsertBillPublicVoteMutationVariables) => fetcher<UpsertBillPublicVoteMutation, UpsertBillPublicVoteMutationVariables>(UpsertBillPublicVoteDocument, variables);
export const BillIssueTagsDocument = /*#__PURE__*/ `
    query BillIssueTags {
  billIssueTags {
    id
    name
    ...
    `;
export const useBillIssueTagsQuery = <
      TData = BillIssueTagsQuery,
      TError = unknown
    >(
      variables?: BillIssueTagsQueryVariables,
      options?: UseQueryOptions<BillIssueTagsQuery, TError, TData>
    ) =>
    useQuery<BillIssueTagsQuery, TError, TData>(
      variables === undefined ? ['BillIssueTags'] : ['BillIssueTags', variables],
      fetcher<BillIssueTagsQuery, BillIssueTagsQueryVariables>(BillIssueTagsDocument, variables),
      options
    );
useBillIssueTagsQuery.document = BillIssueTagsDocument;


useBillIssueTagsQuery.getKey = (variables?: BillIssueTagsQueryVariables) => variables === undefined ? ['BillIssueTags'] : ['BillIssueTags', variables];
;

useBillIssueTagsQuery.fetcher = (variables?: BillIssueTagsQueryVariables) => fetcher<BillIssueTagsQuery, BillIssueTagsQueryVariables>(BillIssueTagsDocument, variables);
export const BillCommitteesDocument = /*#__PURE__*/ `
  ...
  billCommittees {
    ...
    `;
export const useBillCommitteesQuery = <
      TData = BillCommitteesQuery,
      TError = unknown
    >(
      variables?: BillCommitteesQueryVariables,
      options?: UseQueryOptions<BillCommitteesQuery, TError, TData>
    ) =>
    useQuery<BillCommitteesQuery, TError, TData>(
      variables === undefined ? ['BillCommittees'] : ['BillCommittees', variables],
      fetcher<BillCommitteesQuery, BillCommitteesQueryVariables>(BillCommitteesDocument, variables),
      options
    );
useBillCommitteesQuery.document = BillCommitteesDocument;


useBillCommitteesQuery.getKey = (variables?: BillCommitteesQueryVariables) => variables === undefined ? ['BillCommittees'] : ['BillCommittees', variables];
;

useBillCommitteesQuery.fetcher = (variables?: BillCommitteesQueryVariables) => fetcher<BillCommitteesQuery, BillCommitteesQueryVariables>(BillCommitteesDocument, variables);
...
export const useMprFeaturedRacesQuery = <
    ...
    useQuery<MprFeaturedRacesQuery, TError, TData>(
      variables === undefined ? ['MPRFeaturedRaces'] : ['MPRFeaturedRaces', variables],
      fetcher<MprFeaturedRacesQuery, MprFeaturedRacesQueryVariables>(MprFeaturedRacesDocument, variables),
      options
    );
useMprFeaturedRacesQuery.document = MprFeaturedRacesDocument;


useMprFeaturedRacesQuery.getKey = (variables?: MprFeaturedRacesQueryVariables) => variables === undefined ? ['MPRFeaturedRaces'] : ['MPRFeaturedRaces', variables];
;

useMprFeaturedRacesQuery.fetcher = (variables?: MprFeaturedRacesQueryVariables) => fetcher<MprFeaturedRacesQuery, MprFeaturedRacesQueryVariables>(MprFeaturedRacesDocument, variables);
...
export const useElectionBySlugQuery = <
    ...
    useQuery<ElectionBySlugQuery, TError, TData>(
      ...
      fetcher<ElectionBySlugQuery, ElectionBySlugQueryVariables>(ElectionBySlugDocument, variables),
      options
    );
useElectionBySlugQuery.document = ElectionBySlugDocument;


useElectionBySlugQuery.getKey = (variables: ElectionBySlugQueryVariables) => ['ElectionBySlug', variables];
;

useElectionBySlugQuery.fetcher = (variables: ElectionBySlugQueryVariables) => fetcher<ElectionBySlugQuery, ElectionBySlugQueryVariables>(ElectionBySlugDocument, variables);
...
export const useOrganizationPoliticianNotesQuery = <
    ...
    useQuery<OrganizationPoliticianNotesQuery, TError, TData>(
      ...
      fetcher<OrganizationPoliticianNotesQuery, OrganizationPoliticianNotesQueryVariables>(OrganizationPoliticianNotesDocument, variables),
      options
    );
useOrganizationPoliticianNotesQuery.document = OrganizationPoliticianNotesDocument;


useOrganizationPoliticianNotesQuery.getKey = (variables: OrganizationPoliticianNotesQueryVariables) => ['OrganizationPoliticianNotes', variables];
;

useOrganizationPoliticianNotesQuery.fetcher = (variables: OrganizationPoliticianNotesQueryVariables) => fetcher<OrganizationPoliticianNotesQuery, OrganizationPoliticianNotesQueryVariables>(OrganizationPoliticianNotesDocument, variables);
...
export const usePoliticianBasicInfoQuery = <
    ...
    useQuery<PoliticianBasicInfoQuery, TError, TData>(
      ...
      fetcher<PoliticianBasicInfoQuery, PoliticianBasicInfoQueryVariables>(PoliticianBasicInfoDocument, variables),
      options
    );
usePoliticianBasicInfoQuery.document = PoliticianBasicInfoDocument;


usePoliticianBasicInfoQuery.getKey = (variables: PoliticianBasicInfoQueryVariables) => ['PoliticianBasicInfo', variables];
;

usePoliticianBasicInfoQuery.fetcher = (variables: PoliticianBasicInfoQueryVariables) => fetcher<PoliticianBasicInfoQuery, PoliticianBasicInfoQueryVariables>(PoliticianBasicInfoDocument, variables);
...
export const usePoliticianBioQuery = <
    ...
    useQuery<PoliticianBioQuery, TError, TData>(
      ...
      fetcher<PoliticianBioQuery, PoliticianBioQueryVariables>(PoliticianBioDocument, variables),
      options
    );
usePoliticianBioQuery.document = PoliticianBioDocument;


usePoliticianBioQuery.getKey = (variables: PoliticianBioQueryVariables) => ['PoliticianBio', variables];
;

usePoliticianBioQuery.fetcher = (variables: PoliticianBioQueryVariables) => fetcher<PoliticianBioQuery, PoliticianBioQueryVariables>(PoliticianBioDocument, variables);
...
export const usePoliticianCurrentOfficeQuery = <
    ...
    useQuery<PoliticianCurrentOfficeQuery, TError, TData>(
      ...
      fetcher<PoliticianCurrentOfficeQuery, PoliticianCurrentOfficeQueryVariables>(PoliticianCurrentOfficeDocument, variables),
      options
    );
usePoliticianCurrentOfficeQuery.document = PoliticianCurrentOfficeDocument;


usePoliticianCurrentOfficeQuery.getKey = (variables: PoliticianCurrentOfficeQueryVariables) => ['PoliticianCurrentOffice', variables];
;

usePoliticianCurrentOfficeQuery.fetcher = (variables: PoliticianCurrentOfficeQueryVariables) => fetcher<PoliticianCurrentOfficeQuery, PoliticianCurrentOfficeQueryVariables>(PoliticianCurrentOfficeDocument, variables);
...
export const usePoliticianElectionInfoQuery = <
    ...
    useQuery<PoliticianElectionInfoQuery, TError, TData>(
      ...
      fetcher<PoliticianElectionInfoQuery, PoliticianElectionInfoQueryVariables>(PoliticianElectionInfoDocument, variables),
      options
    );
usePoliticianElectionInfoQuery.document = PoliticianElectionInfoDocument;


usePoliticianElectionInfoQuery.getKey = (variables: PoliticianElectionInfoQueryVariables) => ['PoliticianElectionInfo', variables];
;

usePoliticianElectionInfoQuery.fetcher = (variables: PoliticianElectionInfoQueryVariables) => fetcher<PoliticianElectionInfoQuery, PoliticianElectionInfoQueryVariables>(PoliticianElectionInfoDocument, variables);
...
export const usePoliticianEndorsementsQuery = <
    ...
    useQuery<PoliticianEndorsementsQuery, TError, TData>(
      ...
      fetcher<PoliticianEndorsementsQuery, PoliticianEndorsementsQueryVariables>(PoliticianEndorsementsDocument, variables),
      options
    );
usePoliticianEndorsementsQuery.document = PoliticianEndorsementsDocument;


usePoliticianEndorsementsQuery.getKey = (variables: PoliticianEndorsementsQueryVariables) => ['PoliticianEndorsements', variables];
;

usePoliticianEndorsementsQuery.fetcher = (variables: PoliticianEndorsementsQueryVariables) => fetcher<PoliticianEndorsementsQuery, PoliticianEndorsementsQueryVariables>(PoliticianEndorsementsDocument, variables);
...
export const usePoliticianSponsoredBillsQuery = <
    ...
    useQuery<PoliticianSponsoredBillsQuery, TError, TData>(
      ...
      fetcher<PoliticianSponsoredBillsQuery, PoliticianSponsoredBillsQueryVariables>(PoliticianSponsoredBillsDocument, variables),
      options
    );
usePoliticianSponsoredBillsQuery.document = PoliticianSponsoredBillsDocument;


usePoliticianSponsoredBillsQuery.getKey = (variables: PoliticianSponsoredBillsQueryVariables) => ['PoliticianSponsoredBills', variables];
;

usePoliticianSponsoredBillsQuery.fetcher = (variables: PoliticianSponsoredBillsQueryVariables) => fetcher<PoliticianSponsoredBillsQuery, PoliticianSponsoredBillsQueryVariables>(PoliticianSponsoredBillsDocument, variables);
...
export const usePoliticianRatingsQuery = <
    ...
    useQuery<PoliticianRatingsQuery, TError, TData>(
      ...
      fetcher<PoliticianRatingsQuery, PoliticianRatingsQueryVariables>(PoliticianRatingsDocument, variables),
      options
    );
usePoliticianRatingsQuery.document = PoliticianRatingsDocument;


usePoliticianRatingsQuery.getKey = (variables: PoliticianRatingsQueryVariables) => ['PoliticianRatings', variables];
;

usePoliticianRatingsQuery.fetcher = (variables: PoliticianRatingsQueryVariables) => fetcher<PoliticianRatingsQuery, PoliticianRatingsQueryVariables>(PoliticianRatingsDocument, variables);
...
export const usePoliticianFinancialsQuery = <
    ...
    useQuery<PoliticianFinancialsQuery, TError, TData>(
      ...
      fetcher<PoliticianFinancialsQuery, PoliticianFinancialsQueryVariables>(PoliticianFinancialsDocument, variables),
      options
    );
usePoliticianFinancialsQuery.document = PoliticianFinancialsDocument;


usePoliticianFinancialsQuery.getKey = (variables: PoliticianFinancialsQueryVariables) => ['PoliticianFinancials', variables];
;

usePoliticianFinancialsQuery.fetcher = (variables: PoliticianFinancialsQueryVariables) => fetcher<PoliticianFinancialsQuery, PoliticianFinancialsQueryVariables>(PoliticianFinancialsDocument, variables);
...
export const useVotingGuideByIdQuery = <
    ...
    useQuery<VotingGuideByIdQuery, TError, TData>(
      ...
      fetcher<VotingGuideByIdQuery, VotingGuideByIdQueryVariables>(VotingGuideByIdDocument, variables),
      options
    );
...
export const useElectionVotingGuideByUserIdQuery = <
    ...
    useQuery<ElectionVotingGuideByUserIdQuery, TError, TData>(
      ...
      fetcher<ElectionVotingGuideByUserIdQuery, ElectionVotingGuideByUserIdQueryVariables>(ElectionVotingGuideByUserIdDocument, variables),
      options
    );
useElectionVotingGuideByUserIdQuery.document = ElectionVotingGuideByUserIdDocument;
...
export const useVotingGuidesByIdsQuery = <
    ...
    useQuery<VotingGuidesByIdsQuery, TError, TData>(
      ...
      fetcher<VotingGuidesByIdsQuery, VotingGuidesByIdsQueryVariables>(VotingGuidesByIdsDocument, variables),
      options
    );
